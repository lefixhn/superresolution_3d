...
def compare_pseudo_3d_dense_with_3d(
    ...
    model_2d.load(torch.load_state_dict(torch.load(checkpoint_path_2d)), map_location="cpu")
    model_3d.load(torch.load_state_dict(torch.load(checkpoint_path_3d)), map_location="cpu")
